...
also a social activist and [blogger](degeladom.wordpress.com)
...
I'm not sure I'll subscribe to the whole list, but I adopted the concept.
---
class: middle

## The buzz:
Remember: TDD, BDD, XP etc' are just methods (and good methods) to achieve a puprose.  
 ...
 * Karma, Mocha,Zombie etc'
 * casper.js over phantom.js (I wrote a [blogpost](http://4p-tech.co.il/blog/?p=1016) about this one)
---
class: middle
# Functional testing
...
---
class: middle
## introducing [Grunt](http://gruntjs.com/) - a js build tool
